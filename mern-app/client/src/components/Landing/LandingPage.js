      ...
      <div id="hero-section" className="hero-section" style={heroStyle}>
        <div className="hero-content">
          ...
          <div className="main-hero-title">
            ...
            <h1><span>카메라 4대</span>를 <br className="mobile-br" /><span>월 34,000원</span>에 이용하세요!</h1>
        ...
        <div className="price-chart-container">
          ...
          <div className="price-chart-table-wrapper">
            <table className="price-chart-table">
              ...
              <tbody>
                <tr><td>2대</td><td>26,000원</td></tr>
                <tr><td>3대</td><td>30,000원</td></tr>
                <tr><td>4대</td><td>34,000원</td></tr>
                <tr><td>5대</td><td>41,000원</td></tr>
                <tr><td>6대</td><td>45,000원</td></tr>
                <tr><td>7대</td><td>49,000원</td></tr>
                <tr><td>8대</td><td>53,000원</td></tr>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-copyright">
            COPYRIGHT ⓒ 2026 BY OK CCTV ALL Rights Reserved. www.saltcctv.com
          </div>
        </div>
      </footer>
    </div>
